...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\r\x1b[1;37mWELCOME TO GUCCI 悲しいことに歓迎!!\r\n"))
    this.conn.Write([]byte("\r\x1b[1;37mType ? and help 攻撃コマンド\r\n"))
    this.conn.Write([]byte("\r\n\033[0m"))
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\x1b[1;37;47m \x1b[1;37m" + username + " \x1b[1;31m● gucci \033[0m\x1b[1;37m ➤➤ "))
